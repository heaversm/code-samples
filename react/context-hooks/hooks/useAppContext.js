...
export default function useAppContext() {
  ...
  const [doFade, setShowCart] = useState(false); //helps with fading the cart modal
  ...
  const onCartClick = () => {
    setShowCart(doFade => !doFade); //toggle the cart state off or on
  }
...
export const providerPropTypes = {
  value: PropTypes.shape({
    ...
    doFade: PropTypes.bool.isRequired,
  })
};
